...
complete -c clang -o gmodules --description 'Generate debug information that contains external references to types defined…'
...
complete -c clang -o fcommon --description 'This flag specifies that variables without initializers get common linkage.'
complete -c clang -o ftls-model --description 'Set the default thread-local storage (TLS) model to use for thread-local vari…'
complete -c clang -o flto -o emit-llvm --description 'Generate output files in LLVM formats, suitable for link time optimization.'
