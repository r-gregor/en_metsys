...
complete -c smartctl -s g -l get --description 'Get non-SMART device settings.   See \'-s, --set\' below for further info.'
complete -c smartctl -s q -l quietmode --description 'Specifies that smartctl should run in one of the two quiet modes described he…'
...
complete -c smartctl -s f -l format --description '[ATA only] Selects the output format of the attributes:   old - Old smartctl …'
complete -c smartctl -s l -l log --description 'Prints either the SMART Error Log, the SMART Self-Test Log, the SMART Selecti…'
