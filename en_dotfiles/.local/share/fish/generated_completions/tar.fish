...
complete -c tar -s C -l directory --description 'Change to directory DIR.'
...
complete -c tar -l null --description 'Instruct subsequent -T options to read null-terminated names, disable handlin…'
