...
hi Statement	ctermfg=43		cterm=none		guifg=#00ff87	gui=none
hi Constant		ctermfg=173		cterm=none		guifg=#e5786d	gui=none
hi Number		ctermfg=11		cterm=none		guifg=#ffff00	gui=none
hi PreProc		ctermfg=111		cterm=none		guifg=#87afff	gui=none
hi Function		ctermfg=75		cterm=none		guifg=#5fafff	gui=none
hi Identifier	ctermfg=192		cterm=none		guifg=#cae682	gui=none
hi Type			ctermfg=229		cterm=none		guifg=#cae682	gui=none
hi Special		ctermfg=219		cterm=none		guifg=#ffafff	gui=none
" hi String		ctermfg=166		cterm=none		guifg=#d75f00	gui=italic
hi String		ctermfg=173		cterm=none		guifg=#e5786d	gui=italic
